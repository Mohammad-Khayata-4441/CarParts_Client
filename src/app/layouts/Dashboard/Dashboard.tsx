...
const Drawer = styled(MuiDrawer, { shouldForwardProp: (prop) => prop !== "open" && prop !== "drawerWidth", })<{ drawerWidth: number }>(({ theme, open, drawerWidth }) => ({
  width: drawerWidth,
  flexShrink: 0,
  whiteSpace: "nowrap",
...
export default function MiniDrawer(props: any) {
  ...
  return (
    <Box sx={{ display: "flex", transition: '0.3s', flexDirection: 'column', width: { xs: '100%', md: `calc(100% - ${drawerWidth}px)` }, ml: { xs: 0, md: drawerWidth + 'px' } }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, position: "relative", px: 2, pb: 2, mb: { xs: '100px', md: 0 } }}>
        {props.children}
      </Box>
      {/* <BottomNavigation /> */}
    </Box >
